...
@Component({
  selector: 'app-view',
  templateUrl: './events-future-list-page.component.html',
  styleUrls: ['./events-future-list-page.component.scss'],
})

export class EventsFutureListPageComponent implements OnInit {
  auth = getAuth();
